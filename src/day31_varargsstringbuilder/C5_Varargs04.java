...
public class C5_Varargs04 {
	...
	public static void main(String[] args) {
		...
		// kullanicidan deger alarak varargs calistirmak istiyorsak girilen degerleri array'e kaydetmeliyiz. 
		// Bunun icin kullanicidan aldiginiz degerleri esnek old. icin bir list'e koyariz. Sonra list'i array'e ceviririz.
		// 
