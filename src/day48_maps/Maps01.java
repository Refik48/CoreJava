...
public class Maps01 {
	...
	public static void main(String[] args) {
		...
		System.out.println(map2); // {101=Vehr, Bas, java, 102=Esra, Coban, SQL}
		
		System.out.println("\n=====Map putAll=====");
		map1.putAll(map2); 
		System.out.println(map1); // {101=Vehr, Bas, java, 102=Esra, Coban, SQL, 103=Ali, Yan, C#}
		// 2. map'deki butun elemanlari 1.map'e eklicem, 
		...
		map1.putAll(map2);
		System.out.println(map1); // {101=Vehr, Bas, java, 102=Esra, Coban, SQL, 103=Ali, Yan, C#, 104=Omer, Ari, SQL}
		
		map1.putIfAbsent(102, "Ahmet, Demir, Java");
		System.out.println(map1); // {101=Vehr, Bas, java, 102=Esra, Coban, SQL, 103=Ali, Yan, C#, 104=Omer, Ari, SQL}
		
		map1.putIfAbsent(100, "Ahmet, Demir, Java");
		System.out.println(map1); // {100=Ahmet, Demir, Java, 101=Vehr, Bas, java, 102=Esra, Coban, SQL, 103=Ali, Yan, C#, 104=Omer, Ari, SQL}
