...
public class C2_LinkedList02HocaninYazdigi {
	 ...
	 public static void main(String[] args) {
	        ...
	        for (int i = 0; i <10000; i++) { // Donguyu 50 Salisede yapti..
	        ...
	        System.out.println(System.currentTimeMillis());
	        for (int i = 0; i <10000; i++) { // Donguyu 14 Salisede yapti..
	            ll2.add("B"+i);
	            ll2.add(25+i);
	            ll2.add('K'+i);
	        }
	        ...
	        System.out.println(System.currentTimeMillis());
	        for (int i = 0; i <10000; i++) { // Donguyu 3 Salisede yapti..
	            ll3.add(10+i);
	            ll3.add(20+i);
	            ll3.add(30+i);
	        }
