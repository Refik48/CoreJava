...
public class C2_NestedIf {
	...
	public static void main(String[] args) {
		// Nested : ic ice demek
		// Verilen cinsiyet ve yas icin kisinin kisinin emekli olup olmayacagini yazdiran bir java programi yaziniz
		// Eger calisan kadinsa 60 yasindan buyuk old.da emekli olabilir
